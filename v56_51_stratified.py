...
if __name__ == "__main__":
    ...
    if ENABLE_HYPEROPT:
        ...
        hyperopt_space = {
            ...
            "conv_depth"        : hp.quniform("conv_depth", 20, 32, 1),
            "num_hidden"        : hp.quniform("num_hidden", 41, 65, 1),
        }
        ...
        if not PREDICT_ONLY:
            params = {
                'conv_depth': 25.455168023913046,
                'dropout_coeff': 0.4010567144542715,
                'num_hidden': 49.86799859389113,
                'reg_coeff': -9.66174415745061,
                'reg_coeff2': -5.401694895145579
            }
            train_model(params)
